...
import com.badlogic.gdx.maps.tiled.tiles.CellProperties;
...
public class TiledMapTileLayer extends MapLayer {
	...
	public static class Cell implements CellProperties {
		...
		@Override
		public boolean setTileProperty(String property, String value) {
			if (property.equalsIgnoreCase("visibility")) {
				if (value.equalsIgnoreCase("toggle"))
					setVisible(!isVisible());
				else
					setVisible(value.equalsIgnoreCase("true"));
				return true;
			}
			return false;
		}
